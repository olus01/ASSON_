...
export default function CandidatesPage() {
  ...
  const locked = mode !== 'TEST' && !['DRAFT', 'SCHEDULED', 'UPCOMING'].includes(status)
  ...
  async function load() {
    ...
    setRows(data.candidates || []); setPositions(data.positions || []); setStatus(data.status || 'OPEN'); setMode(data.mode || 'LIVE')
