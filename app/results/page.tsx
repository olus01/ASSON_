...
export default function ResultsPage() {
  ...
  if (!data.available) return <main className="results-shell"><p className="eyebrow">ASSON ELECTIONS</p><h1>Results are not yet available.</h1><p>Official results will be available once voting has closed.</p></main>
